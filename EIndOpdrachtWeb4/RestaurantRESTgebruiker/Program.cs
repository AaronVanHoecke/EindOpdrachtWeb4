...
builder.Services.AddSingleton<IGebruikerRepository>(global => new GebruikerRepository(connectionString));
builder.Services.AddSingleton<GebruikerManager>();
builder.Services.AddSingleton<IReservatieRepository>(global => new ReservatieRepository(connectionString));
